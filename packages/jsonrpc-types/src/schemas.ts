...
export type DepositCostFailureReason = "NotEnoughBalance" | "LackBalanceForState";
...
export type EpochSyncConfig = {
     ...
     * @default 2
     */
    epochSyncHorizonNumEpochs: number;
...
export type ErrorWrapper_for_RpcReceiptToTxError = {
    cause: RpcRequestValidationErrorKind;
    /** @enum {string} */
    name: "REQUEST_VALIDATION_ERROR";
} | {
...
export type GasKeyInfo = {
    balance: NearToken;
    /** Format: uint16 */
    numNonces: number;
};
export type GasKeyNoncesView = {
    nonces: number[];
};
...
export type LimitConfig = {
     ...
     */
    maxBlocksPerContract?: number | null;
    /**
     * Format: uint64
     ...
     */
    maxBlocksPerFunction?: number | null;
    /**
     * Format: uint64
     ...
     */
    maxDeployActionsPerReceipt?: number;
    /**
     * Format: uint
     ...
     */
    maxFunctionBodySize?: number | null;
    /**
     * Format: uint64
     ...
     */
    maxInstrumentedCodeSize?: number | null;
    /**
     * Format: uint64
     ...
     */
    maxOperandStackBytesPerFunction?: number | null;
    /** Format: uint64 */
    maxParamsPerContract?: number | null;
    /** Format: uint64 */
    maxParamsPerFunction?: number | null;
    /**
     * Format: uint64
...
export type NonceMode = "monotonic" | "strict";
...
export type RpcClientConfigResponse = {
     ...
     */
    transactionPoolStrictNonceTtlBlocks?: number;
    /** Format: uint */
...
export type RpcQueryRequest = ({
    ...
    publicKey: PublicKey;
    /** @enum {string} */
    requestType: "view_gas_key_nonces";
}) | ({
    blockId: BlockId;
} & {
    accountId: AccountId;
...
export type RpcQueryResponse = {
    ...
    /** Format: uint64 */
    blockHeight: number;
} & (AccountView | ContractCodeView | ViewStateResult | CallResult | AccessKeyView | AccessKeyList | GasKeyNoncesView);
...
export type RpcReceiptToTxError = {
    info: {
        receiptId: CryptoHash;
    };
    /** @enum {string} */
...
export type RpcValidatorResponse = {
     ...
     * @default {}
     */
    validatorRewardPaidPrevEpoch: {
        [key: string]: NearToken;
    };
};
...
export type SignedTransactionView = {
    ...
    nonce: number;
    /** Format: uint16 */
    nonceIndex?: number | null;
    nonceMode?: NonceMode | (null);
    /**
     * Format: uint64
     * @description Deprecated, retained for backward compatibility.
     * @default 0
...
export type RpcQueryRequestViewGasKeyNonces = ({
    blockId: BlockId;
} & {
    accountId: AccountId;
    publicKey: PublicKey;
...
export function DiscriminateRpcQueryResponse(obj: RpcQueryResponse): {
    ...
    let GasKeyNoncesView: ReturnType<typeof DiscriminateRpcQueryResponse>['GasKeyNoncesView'] = undefined
