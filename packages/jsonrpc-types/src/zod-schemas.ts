...
export const AccessKeyListSchema = z.object({
    ...
    lastKey: z.union([z.lazy(() => PublicKeyHandleSchema), z.null()]).optional()
});
...
export const ExtCostsConfigViewSchema = z.object({
    ...
    sha3256Base: z.lazy(() => NearGasSchema).optional(),
    sha3256Byte: z.lazy(() => NearGasSchema).optional(),
    sha3384Base: z.lazy(() => NearGasSchema).optional(),
    sha3384Byte: z.lazy(() => NearGasSchema).optional(),
    sha3512Base: z.lazy(() => NearGasSchema).optional(),
    sha3512Byte: z.lazy(() => NearGasSchema).optional(),
...
export const LimitConfigSchema = z.object({
    ...
    maxOperandStackBytesPerFunction: z.union([z.number(), z.null()]).optional(),
    maxParamsPerContract: z.union([z.number(), z.null()]).optional(),
...
export const RpcClientConfigResponseSchema = z.object({
    ...
    viewAccessKeysLimit: z.number().optional(),
...
export const RpcLightClientExecutionOutcomeProofRequestSchema = z.object({
    lightClientHead: CryptoHashSchema
}).and(z.union([z.object({
    senderId: AccountIdSchema,
...
export const RpcLightClientExecutionOutcomeProofResponseSchema = z.object({
    chunkExecutionProof: ChunkExecutionProofViewSchema,
...
export const RpcLightClientProofErrorSchema = z.union([z.object({
    ...
    name: z.literal("SHARD_NOT_TRACKED")
}), z.object({
    info: z.object({
        accountId: AccountIdSchema,
    ...
    name: z.literal("TARGET_SHARD_MISMATCH")
}), z.object({
    info: z.object({
        chunkId: z.lazy(() => SpiceChunkIdSchema)
    }),
    name: z.literal("STATE_NOT_AVAILABLE")
}), z.object({
    info: z.object({
        chunkId: z.lazy(() => SpiceChunkIdSchema)
    }),
...
export const RpcLightClientStateProofRequestSchema = z.object({
    chunkId: z.lazy(() => SpiceChunkIdSchema),
    lightClientHead: CryptoHashSchema,
    target: z.lazy(() => StateProofTargetSchema)
});
export const RpcLightClientStateProofResponseSchema = z.object({
    chunkExecutionProof: ChunkExecutionProofViewSchema,
...
export const RpcQueryErrorSchema = z.union([z.object({
    ...
    name: z.literal("TOO_MANY_ACCESS_KEYS")
}), z.object({
    info: z.object({
        blockHash: CryptoHashSchema,
        blockHeight: z.number(),
...
export const RpcQueryRequestSchema = z.union([z.object({
    ...
    accountId: AccountIdSchema,
    afterKey: z.union([PublicKeyHandleSchema, z.null()]).optional(),
    limit: z.union([z.number(), z.null()]).optional(),
...
export const RpcViewAccessKeyListResponseSchema = z.object({
    ...
    blockHeight: z.number(),
    keys: z.array(AccessKeyInfoViewSchema),
    lastKey: z.union([PublicKeyHandleSchema, z.null()]).optional()
});
...
export const StateProofTargetSchema = z.union([z.object({
    accountId: AccountIdSchema,
    targetType: z.literal("account")
}), z.object({
    accountId: AccountIdSchema,
    targetType: z.literal("local_contract_code")
}), z.object({
    accountId: AccountIdSchema,
    key: z.lazy(() => StoreKeySchema),
    targetType: z.literal("contract_data")
}), z.object({
    accountId: AccountIdSchema,
    publicKey: PublicKeySchema,
    targetType: z.literal("access_key")
})]);
export const StateProofViewSchema = z.object({
    nodes: z.array(z.string()),
    value: z.union([z.lazy(() => StoreValueSchema), z.null()]).optional()
});
...
export const SyncConfigSchema = z.literal("Peers");
